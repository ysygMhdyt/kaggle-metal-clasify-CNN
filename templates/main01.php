...
<body>
		...
		<div id="top">
			<div id="top-one">
				<dl>
					...
					<dd><a href="main01.php">数据库</a></dd>
					<dd><a href="main01.php" onclick='return confirm("请先登录！");'>数据管理</a></dd>
                    ...
                    <form id= "findform" action="main05.php" method="post">
						...
						<input type="button" name="selsub" id="btn" onclick='return confirm("请先登录！");'>
					</dd>
				</dl>
			</div>
		</div>
    ...
    <!-- 分页 -->
        <div class="footer" id="changepage">
            <dd><a href='main01.php?page=<?php echo $prevpage;?>'>上一页</a>
            <a href='main01.php?page=<?php echo $nextpage;?>'> 下一页</a></dd>
